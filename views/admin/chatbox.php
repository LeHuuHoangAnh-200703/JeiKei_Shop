...
<div class="w-[95%] mx-auto h-[100%]">
    <div class="flex gap-5 p-2">
        <div class="chat w-[35%] flex flex-col gap-3 p-3 bg-white border-2 border-[#cecece] rounded-xl shadow">
            ...
            <div class="overflow-auto flex flex-col items-center justify-center gap-3">
                <div class="flex items-center justify-center gap-3 hover:bg-slate-200 p-2 rounded-full cursor-pointer duration-200 transition-all">
                    <div class="relative">
                    ...
                    <div class="flex flex-col justify-center overflow-hidden">
                        <p class="font-semibold text-[14px]">Lê Hữu Hoàng Anh</p>
                        <div class="w-52 whitespace-nowrap text-ellipsis overflow-hidden text-gray-400">
                            <p class="inline font-medium text-[12px]">Hình ảnh</p>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="relative w-full bg-white border-2 border-[#cecece] rounded-xl shadow">
            <div class="absolute top-0 left-0 px-3 py-3 flex gap-2 items-center shadow w-full">
