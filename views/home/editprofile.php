                    ...
                    <div class="lg:col-span-2">
                        <form action="/editprofile" method="post" class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5" enctype="multipart/form-data">
                            <div class="md:col-span-5">
                                <label for="full_name" class="font-semibold text-[16px]">Full Name</label>
                            ...
                            <div class="md:col-span-5">
                                <label for="email" class="font-semibold text-[16px]">Email Address</label>
                            ...
                            <div class="md:col-span-3">
                                <label for="address" class="font-semibold text-[16px]">Address / Street</label>
                            ...
                            <div class="md:col-span-2">
                                <label for="city" class="font-semibold text-[16px]">Phone</label>
                            ...
                            <div class="md:col-span-5 mt-1">
                                <label for="city" class="font-semibold text-[16px]">Your avatar</label>
                            ...
                            <div class="md:col-span-5 text-right">
                                <div class="inline-flex items-end">
                                    <button type="submit" class="bg-[#333f48] hover:bg-[#DC143C] text-white font-bold py-2 px-4 rounded">Update</button>
                                </div>
                            </div>
