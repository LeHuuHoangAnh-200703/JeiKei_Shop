...
<div class="w-full mx-auto mb-8">
    <div class="w-full flex justify-between items-start flex-col lg:flex-row p-4 gap-3 lg:gap-3 md:gap-x-[60px]">
        <div class="w-[20%] hidden lg:block flex-col py-1 px-2">
            <h2 class="py-2"><i class="fa-solid fa-store text-blue-500"></i><strong> TRADEMARK</strong></h2>
            <hr />
            <ol>
        ...
        <div class="flex flex-col justify-center items-center w-[100%]">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 justify-center">
                <?php
                $type = [
                    ["type" => "shirts", "imgHeight" => "h-30"], ["type" => "shoes", "imgHeight" => "h-36"],
                ...
                ?>
                            <div class="<?php echo $type[$i]["type"] ?> group flex flex-col items-center w-full overflow-hidden rounded-md bg-white shadow-md style">
                                <div class="p-4">
                                    <div class="relative transition-all duration-300 hover:scale-110">
                                    ...
                                    <div class="flex justify-center items-center p-1">
                                        <p class="w-1/2 flex-1 max-w-[45ch] text-sm text-[#DC143C]"><?php echo $this->e($product->price) ?>$</p>
                                ...
                                <div class="w-full">
                                    <div class="px-3 py-6 w-full flex justify-center flex-col gap-3">
