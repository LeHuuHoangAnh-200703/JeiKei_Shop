...
<div class="w-full min-h-screen flex justify-center items-center bg-gradient-to-r from-purple-500 to-pink-500">
    ...
    <div class="max-w-[1300px] lg:bg-[#fff] rounded-md lg:w-10/12 w-full min-[1025px]:min-h-screen lg:m-5 flex overflow-hidden lg:shadow-xl">
        ...
        <form action="/login" method="POST" class="lg:w-1/2 flex justify-center items-center w-full lg:p-3 gap-2">
            <div class="sm:w-[450px] w-[90%] bg-[#fff] flex flex-col justify-center rounded-md p-6 gap-2 shadow-lg">
                <div class="mb-2">
